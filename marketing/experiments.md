...
| 2026-09-21 | Instagram | POSTED — "New on the map — September" 8-slide carousel, the newsletter's twin. https://www.instagram.com/convene.md/p/DdjwOsomNwD/ | caption #12, images `2026-09-update/slide-0[1-8].png` · bio link set to `https://convene.md/new/` same day, hashtags in first comment. **Check `/new/` in the 28 Sep traffic report — first attributable post** |
| 2026-09-21 | Instagram | **FOUND: the bio link had been `convene.me` — wrong domain — through all nine previous posts.** Every "link in bio" tap went off-site. This, not just referrer-stripping, is the likely reason Instagram never registered a referral. Fixed by the owner on mobile the same day (web cannot edit links) | now `convene.md/` |
