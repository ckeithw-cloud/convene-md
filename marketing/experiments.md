...
| 2026-09-21 | Instagram | POSTED — "New on the map — September" 8-slide carousel, the newsletter's twin. https://www.instagram.com/convene.md/p/DdjwOsomNwD/ | caption #12, images `2026-09-update/slide-0[1-8].png` · bio link currently `convene.md/` (homepage) — set it to `/new/` for attribution |
